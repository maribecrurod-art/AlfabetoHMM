...
La utilización de estas bibliotecas responde a necesidades específicas del sistema. OpenCV permitió realizar operaciones de preprocesamiento sobre las imágenes; $\texttt{torchvision}$ proporcionó acceso al conjunto de datos EMNIST; $\texttt{hmmlearn}$ hizo posible la implementación de los modelos ocultos de Markov; mientras que $\texttt{scikit-learn}$ facilitó el cálculo de las métricas de evaluación.
...
## Definición de la topología del HMM
...
Dichas características fueron cuantificadas y codificadas en un conjunto discreto de 256 símbolos observables. Este procedimiento permitió adaptar el problema a la formulación de HMM categóricos, cuyos mecanismos de emisión operan sobre observaciones discretas.
